...
export default async function ReleasesPage() {
  ...
  return <div className="space-y-6">
    ...
    <div className="flex flex-wrap items-center justify-between gap-3 border border-blue-200 bg-blue-50 p-4 text-sm text-blue-950"><span>外部训练完成后，在“模型与训练”登记训练任务和输出模型，再回填评测产物。</span><Link href="/data-lab/models#training-create" className="bg-blue-800 px-3 py-2 text-white">前往模型与训练</Link></div>
  </div>;
}
