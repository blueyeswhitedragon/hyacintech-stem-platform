...
export default async function AiServicesPage() {
  ...
  return <div className="space-y-6">
    <header><h1 className="text-2xl font-semibold">AI 服务</h1><p className="mt-1 text-sm text-gray-500">这里管理“去哪里调用模型”和安全凭据。连接可用后，登记 Endpoint；下一步到“运行组合”把 Endpoint 与模型产物、Prompt 和合同配成可评测方案。</p></header>
    <AIServiceManager
